...
function readMore(event) {
  var _event$target$parentE = _slicedToArray(event.target.parentElement.children, 3),
      dots = _event$target$parentE[0],
      more = _event$target$parentE[1],
      btn = _event$target$parentE[2];
